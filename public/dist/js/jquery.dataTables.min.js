...
(function(h) {
    ...
    function ob(a) {
        var b = a.oClasses,
            ...
            e = a.oPreviousSearch,
            f = a.aanFeatures,
            g = '<input autofocus="autofocus" type="search" class="' + b.sFilterInput + '"/>',
            j = d.sSearch,
        ...
        oLanguage: {
            ...
            oPaginate: {
                ...
                sNext: datatable_next,
                  sPrevious: datatable_prev
            },
            sEmptyTable: datatable_vacio+"...",
            sInfo: datatable_mostrando+" _START_ "+datatable_a+" _END_ "+datatable_from+" _TOTAL_ "+datatable_records,
            sInfoEmpty: datatable_vacio+" 0 "+datatable_a+" 0 "+datatable_from+" 0 "+datatable_records,
            sInfoFiltered: "(filtered from _MAX_ total entries)",
            sInfoPostFix: "",
            sDecimal: "",
            sThousands: ",",
            sLengthMenu: datatable_ver + " _MENU_ "+datatable_records,
            sLoadingRecords: "Loading...",
            sProcessing: '<img src="'+BaseUrl+'/images/loading.gif" width="64" height="64">',
            sSearch: datatable_search+" [F3]:",
            sSearchPlaceholder: "",
            sUrl: "",
            sZeroRecords: datatables_no_match
        },
    ...
    m.ext = x = {
        buttons: {},
        classes: {},
        build: "dt/dt-1.10.16/kt-2.3.2/sl-1.2.3",
        errMode: "alert",
        feature: [],
        search: [],
        selector: {
            ...
            var b = a.rows({
                ...
                l = function(b, c, d) {
                    b.append(e('<span class="select-item"/>').append(a.i18n("select." +
                        c + "s", {
                            _: "%d " + c + "s "+datatable_seleccionado,
                            "0": "",
                            1: "1 " + c + " "+datatable_seleccionado
                        }, d)))
                };
