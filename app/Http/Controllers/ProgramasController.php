...
class ProgramasController extends Controller
{
    ...
    public function __construct() {
        ...
        $this->programa_model = new ProgramasModel();
    ...
    public function index() {
        ...
        $data["subtitle"] = "";
        $data["tabla"] = $this->programa_model->tabla()->HTML();
    ...
    public function buscar_datos() {
        $json_data = $this->programa_model->tabla()->obtenerDatos();
    ...
    public function obtener_programas(Request $request) {
        ...
        $result = $this->programa_model->obtener_programas($request);
        echo json_encode($result);
    }
