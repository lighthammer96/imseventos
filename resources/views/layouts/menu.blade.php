            ...
            <?php
                foreach ($modulos as $key => $value) {
                    echo   '<li class="treeview">
                                <a href="#" ><i class="'.$value->modulo_icono.'"></i><span> '.$value->modulo_nombre.' </span><span class="pull-right-container"><i class="fa fa-angle-left pull-right"></i></span></a>';
                        echo '<ul class="treeview-menu modulo" style="">';
                            foreach ($value->hijos as $hijo) {
                                ...
                                modulo_id="'.$hijo->modulo_id.'"" href="'.URL::to($hijo->modulo_controlador).'" ><i class="fa fa-circle-o"></i>'.$hijo->modulo_nombre.'</a></li>';
